...
assert.strictEqual(run("getMesMap()['2026-07']"),300,'O cartão preserva a parcela de agosto no histórico');
assert.strictEqual(run("getMesMap()['2026-08']"),400,'O cartão preserva também a parcela do dia 10/09');
